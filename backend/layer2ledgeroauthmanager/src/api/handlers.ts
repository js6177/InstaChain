...
export interface Layer2OAuthRouteHandlers {
  ...
  searchUser(body: SearchUserRequest, set: RouteSetStatus): Promise<SearchUserResponse>;
  findUser(body: FindOauthUserRequest, set: RouteSetStatus): Promise<FindOAuthUserResponse>;
  findUserById(
