...
export type Layer2StatusValue =
	(typeof Layer2Status)[keyof typeof Layer2Status];
...
export const pendingWithdrawals = sqliteTable("PendingWithdrawals", {
	...
	withdrawalRequestedTimestamp: integer(
...
export type ConfirmedTransactionInsert =
	typeof confirmedTransactions.$inferInsert;
