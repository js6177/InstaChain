...
await migrateDatabase(sql, {
  dropExisting: process.env.ENVIRONMENT === 'test' && commonConfig.drop_tables_before_test_completed === true,
});
...
const handlers = createRouteHandlers({
  ...
  messaging: {
    ...
    layer2BridgeSigningPublicKey: backendCommonConfig.layer2bridge_signing_public_key,
  },
});
