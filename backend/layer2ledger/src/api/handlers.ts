...
export interface Layer2LedgerRouteHandlers {
  ...
  getDepositAddress(body: GetDepositAddressRequest): Promise<GetDepositAddressResponse>;
  depositConfirmed(body: DepositConfirmedRequest): Promise<DepositConfirmedResponse>;
  requestWithdrawal(body: RequestWithdrawalRequest): Promise<CommonResponse>;
  getWithdrawalRequests(body: GetWithdrawalRequestsRequest): Promise<GetWithdrawalRequestsResponse>;
  withdrawalBroadcasted(body: WithdrawalBroadcastedRequest): Promise<WithdrawalBroadcastedResponse>;
  withdrawalConfirmed(body: WithdrawalConfirmedRequest): Promise<WithdrawalConfirmedResponse>;
  ...
  getAllTransactions(body: GetTransactionsRequest): Promise<GetTransactionsResponse>;
