...
export const depositAddresses = pgTable('deposit_addresses', {
  ...
  signature: varchar('signature').notNull(),
  dateRequested: timestamp('date_requested', { withTimezone: true }).defaultNow().notNull(),
...
export const withdrawalRequests = pgTable('withdrawal_requests', {
  ...
  withdrawalRequestedTimestamp: bigint('withdrawal_requested_timestamp', { mode: 'number' }).notNull(),
  withdrawalRequestedTimestampStr: timestamp('withdrawal_requested_timestamp_str', {
    withTimezone: true,
  })
    .defaultNow()
    .notNull(),
...
export const confirmedWithdrawals = pgTable('confirmed_withdrawals', {
  ...
  confirmationTimestampStr: timestamp('confirmation_timestamp_str', { withTimezone: true })
    .defaultNow()
    .notNull(),
});
