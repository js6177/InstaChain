...
The stress entrypoint uses grafana/k6 for HTTP load. Bun (`@openl2/stress-testing`) prepares
signed request bodies and finalizes profiler sessions; see `backend/stress-testing/README.md`
and `make stress-test`.
