...
export interface BitcoinRpcClient {
  ...
  getConfirmedTransactions(lastBlockHash: string): Promise<ListSinceBlockResult>;
  ...
  broadcastTransaction(pendingWithdrawals: BroadcastWithdrawalInput[]): Promise<string>;
