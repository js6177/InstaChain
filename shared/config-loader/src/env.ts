...
export function loadLayer2LedgerDockerEnvSettings(
	...
	return {
		...
		layer2ledgerApihandlerDebugPort: optionalEnvNumber(
			values,
			"LAYER2LEDGER_APIHANDLER_DEBUG_PORT",
		),
		layer2ledgerDbwriterDebugPort: optionalEnvNumber(
			values,
			"LAYER2LEDGER_DBWRITER_DEBUG_PORT",
		),
		...
		layer2ledgerApihandlerHost: requireEnvValue(
			values,
			"LAYER2LEDGER_APIHANDLER_HOST",
		),
	};
}
