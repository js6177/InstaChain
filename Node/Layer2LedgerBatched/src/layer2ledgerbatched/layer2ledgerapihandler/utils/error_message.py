...
ERROR_INVALID_SOURCE_ADDRESS = 35
ERROR_INVALID_DESTINATION_ADDRESS = 36
ERROR_INVALID_AMOUNT = 37
ERROR_DUPLICATE_TRANSACTION = 11 # re-using, as it is the same
...
error_mapping = {
    ...
    ERROR_INVALID_SOURCE_ADDRESS: "Invalid source address",
    ERROR_INVALID_DESTINATION_ADDRESS: "Invalid destination address",
