...
secp.etc.hmacSha256Sync = (
	key: Uint8Array,
	...msgs: Uint8Array[]
): Uint8Array => hmac(sha256, key, secp.etc.concatBytes(...msgs));
...
class Layer2Transaction {
	...
	fromGetTransactionsResponseTransaction(
		...
		this.signature_date = transaction.signature_date
			? transaction.signature_date
			: null;
		this.layer1_transaction_id = transaction.layer1_transaction_id
			? transaction.layer1_transaction_id
			: null;
