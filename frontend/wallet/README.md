...
| --- | --- | --- | --- |
| 'AdressBalance' | address_pubkey | '/get_balance' | Get the balance of a layer2 address |
| 'Transaction' | transaction_id | '/get_transaction' | Get a layer2 transaction info |
| 'Transactions' | address_pubkey | '/get_all_transactions' | Get all layer2 transactions of an layer2 address |
| 'DepositAddress' | address_pubkey | '/get_deposit_address' | Get the layer1 deposit address for a layer2 address |
...
- Deposit: Allows a user to generate a layer1 deposit address
- Withdraw: Allows a user to withdraw to a layer1 address.
- Transfer: Allows a user to transfer to another layer2 address.
